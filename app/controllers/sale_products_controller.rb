class SaleProductsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sale_product.save
        Stocking.update_stock(sale_product_params, @sale_product.id)
        format.html { redirect_to sale_path(@sale_product.sale_id), notice: 'Sale product was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @sale_product.update(sale_product_params)
        format.html { redirect_to sale_path(@sale_product.sale_id), notice: 'Sale product was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sale_path(@sale_product.sale_id), notice: 'Sale product was successfully destroyed.' }
  ...
  private
    ...
    def sale_product_params
      params.require(:sale_product).permit(:sale_id, :product_id, :quantity, :total, :number)
    end
end
